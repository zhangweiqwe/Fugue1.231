package cn.wsgwz.tun.gravity.provider;
...
public final class AppContentProvider extends ContentProvider {;
    ...
    static {
        ...
        uriMatcher.addURI(Const.App.PACKAGE_NAME,PATH_SETTING_SUSPENSION_COLOR,CODE_SETTING_SUSPENSION_COLOR);
        uriMatcher.addURI(Const.App.PACKAGE_NAME,PATH_SETTING_SEED_X_LOCATION,CODE_SETTING_SEED_X_LOCATION);
        uriMatcher.addURI(Const.App.PACKAGE_NAME,PATH_SETTING_SEED_Y_LOCATION,CODE_SETTING_SEED_Y_LOCATION);
    }
    private ContentResolver contentResolver;
    private DbHelper dbHelper;
    //构造器不能私有
    public AppContentProvider(){
        //LogUtil.printSS("  AppContentProvider()");
    }
    @Nullable
    @Override
    ...
    public boolean onCreate() {
        ...
        //LogUtil.printSS("AppContentProvider  onCreate()");
    ...
    public final   class DbHelper extends SQLiteOpenHelper{
       ...
       /* public DbHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version, DatabaseErrorHandler errorHandler) {
        ...
        public void onCreate(SQLiteDatabase sqLiteDatabase) {
            String sql = "create table "+TABLE_NAME+"("+_ID+" integer primary key autoincrement,"+_SUSPENSION_COLOR+" varchar(16),"
                    +_SPEED_VIEW_X_LOCATION+" real,"+_SPEED_VIEW_Y_LOCATION+" real"+");";
            String sql2 = "insert into "+TABLE_NAME+"("+_SPEED_VIEW_X_LOCATION+","+_SPEED_VIEW_Y_LOCATION+") "+"values("+"100,314"+")";
